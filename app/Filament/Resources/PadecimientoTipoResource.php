...
use App\Filament\Resources\PadecimientoTipoResource\Pages;
...
class PadecimientoTipoResource extends Resource
{
    use ChecksAdmin;

    protected static ?string $model = PadecimientoTipo::class;
    ...
    {
        return [
            'index'  => Pages\ListPadecimientoTipos::route('/'),
            'create' => Pages\CreatePadecimientoTipo::route('/create'),
            'edit'   => Pages\EditPadecimientoTipo::route('/{record}/edit'),
        ];
    }
}
