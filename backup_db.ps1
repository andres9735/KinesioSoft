...
# Armar argumentos (usar --result-file para evitar redirecciones)
# --databases agrega CREATE DATABASE/USE, útil para restaurar
# --single-transaction y --skip-lock-tables para dumps consistentes sin bloquear
# Ajusta el charset a utf8mb4
$pwdArg = ""
if ($DbPass -ne "") { $pwdArg = "-p$DbPass" }   # importante: sin espacio
$args = @(
  "-h", $DbHost,
  "-u", $DbUser,
  $pwdArg,
